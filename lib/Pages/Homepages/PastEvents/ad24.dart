...
class Ad24 extends StatefulWidget {
  const Ad24({super.key});

  @override
  State<Ad24> createState() => _Ad24State();
}

class _Ad24State extends State<Ad24> {
  ...
  @override
    Widget build(BuildContext context) {
      return Scaffold(
        appBar: AppBar(
          title:
            Text('Advitiya 2024', style: TextStyle(fontWeight: FontWeight.bold)),
